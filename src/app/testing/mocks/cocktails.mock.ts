import { CocktailListResponse, CocktailViewModel, HasAlcoholEnum } from '@shared/models'

export const CocktailsMock: CocktailListResponse = {
  "drinks": [
    {
      "idDrink": "17222",
      "strDrink": "A1",
      ...
      "strIBA": null,
      "strAlcoholic": "Alcoholic" as HasAlcoholEnum,
...
export const CocktailsViewMock = CocktailsMock.drinks.map(cocktail => new CocktailViewModel(cocktail));
